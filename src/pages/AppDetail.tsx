    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-[#1E293B] mb-2">App Not Found</h2>
    ...
    <div className="min-h-screen py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-12">
          ...
          >
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold text-[#1E293B] mb-2">{name}</h1>
            ...
            <div className="flex items-center gap-4 p-4 bg-white/5 rounded-xl">
              ...
              <div className="flex-1 border-l border-gray-200 pl-4">
                <p className="text-gray-400 text-sm">{formatNumber(app.totalReviews)} reviews</p>
                <p className="text-gray-400 text-sm">{formatNumber(app.downloadCount)} downloads</p>
              </div>
            </div>
            ...
            <div className="p-6 bg-gradient-to-br from-[hsl(var(--exsify-primary))]/20 to-[hsl(var(--exsify-primary))]/5 rounded-xl border border-gray-200">
              ...
              {app.downloadUrl && (
                <a
                  ...
                  className="mt-3 flex items-center justify-center gap-2 px-6 py-3 bg-white border-2 border-[hsl(var(--exsify-primary))] text-[hsl(var(--exsify-primary))] rounded-xl font-semibold hover:bg-[hsl(var(--exsify-primary))] hover:text-white transition-colors text-sm"
                >
            ...
            {/* Available Regions */}
            <div>
              <h3 className="text-[#1E293B] font-bold mb-3">Available In</h3>
        ...
        {relatedApps.length > 0 && (
          ...
          >
            <h2 className="text-2xl font-bold text-[#1E293B] mb-6">{t('apps.relatedApps')}</h2>
              ...
              {relatedApps.map(relatedApp => {
                ...
                return (
                  <Link
                    ...
                    className="group bg-white rounded-xl border border-gray-200 p-4 hover:border-[hsl(var(--exsify-primary))]/50 transition-all"
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className="text-[#1E293B] font-bold group-hover:text-[hsl(var(--exsify-primary))] transition-colors">
                          {relatedName}
                        </h3>

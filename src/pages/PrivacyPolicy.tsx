      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8 md:p-12">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-[#1E293B]">Privacy Policy</h1>
          </div>
          ...
          <div className="space-y-8 text-gray-600 leading-relaxed">
            <section>
              <h2 className="text-xl font-bold text-[#1E293B] mb-3">1. Information We Collect</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1E293B] mb-3">2. How We Use Your Information</h2>
              <ul className="list-disc list-inside space-y-2">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1E293B] mb-3">3. Sharing and Disclosure</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1E293B] mb-3">4. Data Storage and Security</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1E293B] mb-3">5. Cookies and Similar Technologies</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1E293B] mb-3">6. Account Deletion</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1E293B] mb-3">7. Children’s Privacy</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1E293B] mb-3">8. International Data Transfers</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1E293B] mb-3">10. Contact Us</h2>
              <p>

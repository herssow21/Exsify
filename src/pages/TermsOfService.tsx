...
export default function TermsOfService() {
  ...
  return (
    <div className="min-h-screen py-12 bg-[#F8FAFC]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <Link
          to="/"
          className="inline-flex items-center gap-2 text-gray-500 hover:text-[hsl(var(--exsify-primary))] transition-colors mb-8"
        >
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8 md:p-12">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-[#1E293B]">Terms of Service</h1>
          </div>
          ...
          <div className="space-y-8 text-gray-600 leading-relaxed">
            <section>
              <h2 className="text-xl font-bold text-[#1E293B] mb-3">1. Acceptance of Terms</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1E293B] mb-3">2. Accounts and Security</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1E293B] mb-3">3. Licenses and Restrictions</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1E293B] mb-3">4. Purchases, Subscriptions, and Refunds</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1E293B] mb-3">5. User Content</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1E293B] mb-3">6. Intellectual Property</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1E293B] mb-3">7. Disclaimers</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1E293B] mb-3">8. Limitation of Liability</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1E293B] mb-3">9. Indemnification</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1E293B] mb-3">10. Termination</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1E293B] mb-3">11. Governing Law and Disputes</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1E293B] mb-3">12. Changes to These Terms</h2>
              <p>

...
export default function ReviewCard({ review, index = 0 }: ReviewCardProps) {
  ...
  return (
    <motion.div
      ...
      className="bg-white dark:bg-[#1E293B] rounded-xl border border-gray-200 dark:border-white/10 p-6 hover:border-[hsl(var(--exsify-primary))]/40 transition-all duration-300"
    >
      {/* Quote Icon */}
      ...
      <div className="flex items-center gap-3 pt-4 border-t border-gray-200 dark:border-white/10">
        ...
        <div className="flex-1">
          <h4 className="text-[#1E293B] dark:text-white font-medium text-sm">{review.userName}</h4>
